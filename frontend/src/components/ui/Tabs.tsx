...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-sm border border-brand-border bg-brand-surface p-1 text-brand-muted",
      className,
    )}
    {...props}
  />
